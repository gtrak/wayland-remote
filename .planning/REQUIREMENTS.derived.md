...
- [ ] **DER-REND-01** (from REND-01): Configure Smithay with Virtual backend
- [ ] **DER-REND-02** (from REND-01): Initialize PixmanRenderer for CPU rendering
...
- [ ] **DER-VIEW-02** (from VIEW-01): Async frame reading with tokio
