...
plan: 01
subsystem: rendering
tags: [pixman, smithay, headless, offscreen]

# Dependency graph
requires:
  - phase: 02-wayland-core-protocol
    provides: ServerState foundation with compositor, seat, shm, output
provides:
...
affects: [frame-streaming, buffer-rendering, pixel-extraction]

# Tech tracking
tech-stack:
  added: [pixman 0.2.1, pixman-sys 0.1.0]
  patterns: [PixmanRenderer::new() initialization in ServerState::new()]
