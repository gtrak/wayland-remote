...
3. **Requirements emerged?**
   ...
   **IMPORTANT: Also update REQUIREMENTS.authoritative.md**
   ...
   4. Commit: `node ./.opencode/get-shit-done/bin/gsd-tools.cjs commit "docs: add authoritative requirements from phase ${PHASE} transition" --files .planning/REQUIREMENTS.authoritative.md`
