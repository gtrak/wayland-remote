...
```bash
node ./.opencode/get-shit-done/bin/gsd-tools.cjs commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.authoritative.md .planning/REQUIREMENTS.derived.md
```
