...
**Commit requirements:**
```bash
node ./.opencode/get-shit-done/bin/gsd-tools.cjs commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.authoritative.md .planning/REQUIREMENTS.derived.md
```
...
```bash
node ./.opencode/get-shit-done/bin/gsd-tools.cjs commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.authoritative.md .planning/REQUIREMENTS.derived.md
```
